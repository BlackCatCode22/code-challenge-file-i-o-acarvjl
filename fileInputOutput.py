...
#
# Python file name: fileInputOutput.py
#
# Date: 9/21/2023
#
...
# testing string for funciton
# my_str = 'Python is an awesome programming language!'

def get_species(my_str):
    words = my_str.split()
    # TODO: find the data type of words. What can you do with words?
    print(type(words)) # my_str is a string when we split it becomes a type list, 
    return words[4] # now it returns the word in location 4 in this case 'programming'.
...
try:
    with open(input_file_path, 'r') as input_file:
        ...
        print(type(lines))
        # TODO: Fill in the blank: The readlines() method returns a __list___ containing all the text lines of input_file.
        # TODO: Output the 2nd and 4th list elements
        linesTwo = lines[2]
        linesFour = lines[4]
        print(f"The second list element is: {linesTwo}")
        print(f"The fourth list element is: {linesFour}")
        ...
        with open(output_file_path, "w") as output_file:
            for line in lines:
                ...
                print(f"the first element of substring is: {substrings[0]}")
                print(f"the second element of substring is: {substrings[1]}")
                # TODO: Call get_species and output the species. What will you use for input?
                species = get_species(linesFour)
                print(f"the spcies is: {species}")
                # hint: print(f"the species is: {....}")
                # TODO: Use a "for each" loop to output the substrings on different lines.
                
                for sub in substrings:
                # print(sub)
                    for character in substrings:
                        print(character)
...
# Tested with file close and got all these errors also, with a drive locked.
